...
def main(train_rgb_path,
    ...
    model.load_deeplabv3_pretrained_state_dict(torch.load(pretrained_model)['model_state'])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_model", help="pretrained model path", type=str, default="../data/pretrained/best_deeplabv3_resnet50_voc_os16.pth")
